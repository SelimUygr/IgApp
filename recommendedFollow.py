...
class randomFollow:
    ...
    def goToRecommended(self):
        WebDriverWait(self.driver,10).until(EC.visibility_of_element_located((By.XPATH,'//*[@id="react-root"]/section/main/section/div[3]/div[2]/div[1]/a/div')))
        self.driver.get('https://www.instagram.com/explore/people/suggested/')
        WebDriverWait(self.driver,10).until(EC.visibility_of_element_located((By.XPATH,'//*[@id="react-root"]/section/main/div/div[2]/div/div/div[1]')))

    #Following dailyFollow times people in the recommended page
    def followAll(self):
        for i in range(1,50):
            try:
                element = WebDriverWait(self.driver,5).until(EC.visibility_of_element_located((By.XPATH,f'//*[@id="react-root"]/section/main/div/div[2]/div/div/div[{i}]/div[3]/button')))
